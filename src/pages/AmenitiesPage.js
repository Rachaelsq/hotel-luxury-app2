      ...
      <div class="col-xl container-fluid " id="firstColumn">
        <div class="row">
          ...
          <div class="col-xl container-fluid  ">
            <div class="row row-no-padding topRow" id="topSideImgId">
            ...
            <h4 class="container-fluid justify-content-center d-flex">Golfing & hiking</h4>
            <div class="container-fluid justify-content-center d-flex " id="bottomAmenitiesId">
              <img src="https://images.unsplash.com/photo-1610916445778-09401a50a2b2?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class=" bottomImg container-fluid " alt="golf" />
              <img src="https://images.unsplash.com/photo-1600599067176-1f47e3b6fe47?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=798&q=80" class=" bottomImg container-fluid" alt="hiking" />
            </div>
            
            <h4 class="container-fluid justify-content-center d-flex">50 restaurants to choose from</h4>
            <div class="container-fluid justify-content-center d-flex" id="bottomAmenitiesId">
              <img src="https://images.unsplash.com/photo-1600905802115-e185ef10fedb?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=802&q=80" class=" bottomImg container-fluid " alt="cafe" />
              <img src="https://images.unsplash.com/photo-1563019880-9b2ea5d89a12?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class=" bottomImg container-fluid" alt="fine dining" />
            </div>
        </div>
          ...
          <div class="col-xl container-fluid" id="middleColumn">
            ...
            <div class="row row-no-padding ">
              ...
              <img src="https://images.unsplash.com/photo-1588504273983-667893edbe3d?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class="topRow " alt="Responsive image" />
              <h4 class="container-fluid justify-content-center d-flex">Marina access & boat rental</h4>
          ...
          <div class="col-xl container-fluid" id="lastColumn">
            <div class="row row-no-padding topRow">
            ...
            <h4 class="container-fluid justify-content-center d-flex">Yoga & spa</h4>
            <div class="container-fluid justify-content-center d-flex" id="bottomAmenitiesId">
              <img src="https://images.unsplash.com/photo-1590079083219-5bc40d5a9d69?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=833&q=80" class=" bottomImg container-fluid rightPadding" alt="Responsive image" />
              <img src="https://images.unsplash.com/photo-1485727749690-d091e8284ef3?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class=" bottomImg container-fluid rightPadding" alt="Responsive image" />
            </div>   

            <h4 class="container-fluid justify-content-center d-flex">Games & entertainment</h4>               
            <div class="container-fluid justify-content-center d-flex" id="bottomAmenitiesId">
              <img src="https://images.unsplash.com/photo-1593508512255-86ab42a8e620?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=798&q=800" class=" bottomImg container-fluid rightPadding" alt="Responsive image" />
              <img src="https://images.unsplash.com/photo-1514891163508-4d0d04535922?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class=" bottomImg container-fluid rightPadding" alt="Responsive image" />
            </div>                  
          </div>
