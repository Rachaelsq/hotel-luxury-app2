        ...
        <div className="App">          
            <div class="container-fluid" id="homeImgRow">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg ">
                        <h2 class="viewRmTitle">The Elm <h6>(coming soon)</h6></h2>
                            <img src="https://images.unsplash.com/photo-1584537319035-d6f4fb63f4c4?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class="img-fluid viewRmImg " alt="Responsive image" />
                        </div>
                        <div class="col-lg ">
                        <h2 class="viewRmTitle">The Oak <h6>(coming soon)</h6></h2>
                            <img src="https://images.unsplash.com/photo-1522107177-01884fcfa2bb?ixid=MXwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" class="img-fluid viewRmImg" alt="Responsive image" />
                        </div>
                    </div>
</div>
